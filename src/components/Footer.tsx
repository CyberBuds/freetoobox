      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/download-app" className="text-gray-500 hover:text-blue-600">Download App</Link></li>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <div className="text-gray-400 text-sm">
            <p>© {new Date().getFullYear()} FreeToolsBox. All rights reserved.</p>
            <p className="mt-1">
              Designed & Developed by <a href="https://www.cyberbuds.in/" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-medium hover:underline">CyberBuds</a>
            </p>
          </div>
