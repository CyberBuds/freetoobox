  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-500">Plan your loans better with our easy-to-use EMI calculator.</p>
      </div>
      ...
      <article className="prose prose-blue max-w-none bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
          ...
          <li><strong>Instant Results:</strong> Get immediate feedback on how changing your loan amount or tenure affects your monthly outgoings.</li>
        </ul>

        <p className="text-gray-600">
          Whether you're planning for a home loan, car loan, or personal loan, our EMI calculator provides the clarity you need to make an informed financial decision.
        </p>
      </article>
